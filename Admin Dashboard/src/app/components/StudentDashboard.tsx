...
import type { LevelData } from "./LevelDetailSheet";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            border: "1px solid rgba(200,52,46,0.4)",
            flexShrink: 0,
          }}
        >
          <span
      ...
      <div style={{ padding: "22px 16px 4px", display: "flex", alignItems: "center", gap: "10px" }}>
        <div style={{ width: "3px", height: "16px", backgroundColor: "#C8342E", borderRadius: "2px", flexShrink: 0 }} />
        <p style={{ color: "#FFFFFF", fontSize: "15px", fontFamily: "var(--font-heading)", fontStyle: "normal", fontWeight: 900, letterSpacing: "0px", margin: 0 }}>
          Your Racing Journey
        </p>
        <div style={{ flex: 1, height: "1px", backgroundColor: "rgba(255,255,255,0.06)" }} />
      </div>

      <p style={{ color: "#555555", fontSize: "11px", lineHeight: 1.45, margin: "0 0 8px 0", padding: "0 16px" }}>
      ...
      <div style={{ textAlign: "center", padding: "8px 16px 4px" }}>
        <p style={{ color: "#222222", fontSize: "10px", fontWeight: 600, letterSpacing: "0px", textTransform: "uppercase", margin: 0 }}>
      ...
      >
        <button
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.backgroundColor = "#A82824";
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.backgroundColor = "#C8342E";
          }}
        >
