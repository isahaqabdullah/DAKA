              ...
              <aside className="sidebar">
                <nav className="sidebar-card">
                  ...
                  <div className="sidebar-group">
                    ...
                    <NavButton label="Sessions" icon={<CalendarDays size={15} />} active={view === "admin-attendance"} onClick={() => goAttendance()} badge={needsAttendanceBadge} />
              ...
              <div className="content">
                {view === "admin-attendance" ? (
                  <AdminAttendancePage
                    ...
                    onOpenCohortsPage={() => go("cohorts", { cohortId: attendanceContext.cohortId || effectiveCohortId })}
                    onOpenCohortPage={(cohortId) => go("dashboard", { cohortId })}
