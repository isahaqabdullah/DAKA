...
import { DAKAHeader } from "./DAKAHeader";
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "22px 16px 4px", display: "flex", alignItems: "center", gap: "10px" }}>
        ...
        <p style={{ color: "#FFFFFF", fontSize: "13px", fontFamily: "var(--font-heading)", fontStyle: "italic", fontWeight: 800, letterSpacing: "0px", textTransform: "uppercase", margin: 0 }}>
          Your Racing Journey
        </p>
        <div style={{ flex: 1, height: "1px", backgroundColor: "rgba(255,255,255,0.06)" }} />
      </div>

      <p style={{ color: "#3A3A3A", fontSize: "11px", margin: "0 0 8px 0", padding: "0 16px" }}>
